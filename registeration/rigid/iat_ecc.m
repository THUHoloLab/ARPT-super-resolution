function [warp, rho] = iat_ecc(image, template, par)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [WARP, RHO] = IAT_ECC(IMAGE, TEMPLATE, PAR)
% IAT_ECC implements the forwards-addiitve version of ECC image alignment 
...
% Coefficient [1] between TEMPLATE and warped IMAGE.
%
% -->Input:
...
if nargin<2
    error('iat_ecc:Not enough input arguments');
end
...
%         disp(' -> Press any key to continue.')
    ...
    for i=1:noi
        ...
        rho = dot(temp(:),wim(:)) / norm(tempzm(:)) / norm(wim(:));
